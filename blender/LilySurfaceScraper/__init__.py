...
bl_info = {
    ...
    "author": "Élie Michel <elie.michel@exppad.com> and Tiefseetauchner <tiefseetauchner@lukechriswalker.at>",
    "version": (1, 9, 1),
    "blender": (4, 1, 0),
    ...
    "warning": "",
    "wiki_url": "",
    "tracker_url": "https://github.com/Tiefseetauchner/LilySurfaceScraper/issues",
    "support": "COMMUNITY",
    "category": "Import",
}
